...
type Params struct {
	...
	ClientTimeout *types.Duration `protobuf:"bytes,8,opt,name=client_timeout,json=clientTimeout" json:"client_timeout,omitempty"`
...
func (*Params) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_a4ade39dcab468d2, []int{0}
}
...
type ParamsProductOptions struct {
	...
	RefreshRate          *types.Duration `protobuf:"bytes,1,opt,name=refresh_rate,json=refreshRate" json:"refresh_rate,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (*ParamsProductOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_a4ade39dcab468d2, []int{0, 0}
}
...
func (dst *ParamsProductOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParamsProductOptions.Merge(dst, src)
}
...
func (*ParamsAnalyticsOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_config_a4ade39dcab468d2, []int{0, 1}
}
...
func (dst *ParamsAnalyticsOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParamsAnalyticsOptions.Merge(dst, src)
}
...
func init() { proto.RegisterFile("adapter/config/config.proto", fileDescriptor_config_a4ade39dcab468d2) }

var fileDescriptor_config_a4ade39dcab468d2 = []byte{
