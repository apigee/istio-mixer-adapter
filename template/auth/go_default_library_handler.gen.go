...
// Instance is constructed by Mixer for the 'auth' template.
...
// process data associated with the 'auth' template.
//
...
type HandlerBuilder interface {
	...
	// SetAuthTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetAuthTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetAuthTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleAuth is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleAuth(context.Context, *Instance) (adapter.CheckResult, error)
}
