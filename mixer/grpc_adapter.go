...
// build the protos
//go:generate $GOPATH/src/github.com/apigee/istio-mixer-adapter/bin/codegen.sh -a mixer/config/config.proto -x "-n apigee -s=false -t apigee-authorization -t apigee-analytics"
...
import (
	...
	"github.com/apigee/istio-mixer-adapter/mixer/analytics"
