...
if [[ `command -v goreleaser` == "" ]]; then
  ...
  cd "${GOPATH}/bin/"
  wget https://github.com/goreleaser/goreleaser/releases/download/v0.85.2/goreleaser_Darwin_x86_64.tar.gz
  tar xfz goreleaser_Darwin_x86_64.tar.gz goreleaser
